...
class CreatePostViewController: UIViewController{
    private lazy var formContentBuilder = CreatePost()
    ...
    private lazy var collectionView: UICollectionView = {
        ...
        cv.register(FormSmallButtonCollectionViewCell.self, forCellWithReuseIdentifier: FormSmallButtonCollectionViewCell.cellId)
        return cv
    }()
    ...
    var content: [FormSectionComponent]{
        return [
            FormSectionComponent(items: [ //the dynamic array
                ...
                TextFormComponent(placeholder: "Post", fontColor: .black),
                TextBoxFormComponent(placeholder: "Insert Text", keyboardType: .default),
                SmallButtonFormComponent(title: "Add multimedia"),
