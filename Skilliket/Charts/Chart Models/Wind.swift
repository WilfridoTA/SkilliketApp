...
struct WindData2: Identifiable, Equatable, Codable {
    let id: UUID
    let velocity: Float
    ...
    let time: Date
     ...
     static var examples: [WindData2] = [
     WindData2(id: UUID(), velocity: 4.3, waterLevel: 1.2, noiseLevel: 48.0, celsius: 20.0, date: Date(timeIntervalSinceNow: -7_200_000), time: Date()),
     WindData2(id: UUID(), velocity: 3.8, waterLevel: 1.8, noiseLevel: 52.0, celsius: 21.0, date: Date(timeIntervalSinceNow: -14_400_000), time: Date()),
     WindData2(id: UUID(), velocity: 5.5, waterLevel: 2.0, noiseLevel: 55.0, celsius: 22.5, date: Date(timeIntervalSinceNow: -21_600_000), time: Date()),
     WindData2(id: UUID(), velocity: 6.2, waterLevel: 0.9, noiseLevel: 47.0, celsius: 19.5, date: Date(timeIntervalSinceNow: -28_800_000), time: Date()),
     WindData2(id: UUID(), velocity: 4.1, waterLevel: 1.6, noiseLevel: 49.0, celsius: 23.0, date: Date(timeIntervalSinceNow: -36_000_000), time: Date())
     ]
     
     // Generates wind data for the last three months
     static func threeMonthsExamples() -> [WindData2] {
     let threeMonthsAgo = Calendar.current.date(byAdding: .month, value: -3, to: Date())!
     
     let exampleWindData: [WindData2] = (1...300).map { _ in
     ...
     static var higherWeekendThreeMonthsExamples: [WindData2] = {
     let threeMonthsAgo = Calendar.current.date(byAdding: .month, value: -3, to: Date())!
     let exampleWindData: [WindData2] = (1...300).map { _ in
     let randomDate = Date.random(in: threeMonthsAgo...Date())
