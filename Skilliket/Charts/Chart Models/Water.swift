...
struct WaterData2: Identifiable, Equatable, Codable {
    ...
    let time: Date
     ...
     WaterData2(id: UUID(), waterLevel: 1.2, velocity: 4.5, noiseLevel: 48.0, celsius: 20.0, date: Date(timeIntervalSinceNow: -7_200_000), time: Date()),
     WaterData2(id: UUID(), waterLevel: 1.8, velocity: 5.2, noiseLevel: 52.0, celsius: 21.0, date: Date(timeIntervalSinceNow: -14_400_000), time: Date()),
     WaterData2(id: UUID(), waterLevel: 2.0, velocity: 5.8, noiseLevel: 55.0, celsius: 22.5, date: Date(timeIntervalSinceNow: -21_600_000), time: Date()),
     WaterData2(id: UUID(), waterLevel: 0.9, velocity: 3.5, noiseLevel: 47.0, celsius: 19.5, date: Date(timeIntervalSinceNow: -28_800_000), time: Date()),
     WaterData2(id: UUID(), waterLevel: 1.6, velocity: 6.0, noiseLevel: 49.0, celsius: 23.0, date: Date(timeIntervalSinceNow: -36_000_000), time: Date())
     ]
